#!/bin/bash
#SBATCH --job-name=train_variable_gru
...
#SBATCH --mem=32G                       # RAM
#SBATCH --output=/cluster/work/smslab/2025-eeg_headband/logs/train_variable_gru_%j.out
#SBATCH --error=/cluster/work/smslab/2025-eeg_headband/logs/train_variable_gru_%j.err

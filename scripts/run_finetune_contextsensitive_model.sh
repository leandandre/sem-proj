#!/bin/bash
#SBATCH --job-name=finetune_ctxsensitive
...
#SBATCH --mem=32G                       # RAM
#SBATCH --output=/cluster/work/smslab/2025-eeg_headband/logs/finetune_ctxsensitive_%j.out
#SBATCH --error=/cluster/work/smslab/2025-eeg_headband/logs/finetune_ctxsensitive_%j.err

#!/bin/bash
#SBATCH --job-name=finetune_ctxfree
...
#SBATCH --mem=32G                       # RAM
#SBATCH --output=/cluster/work/smslab/2025-eeg_headband/logs/finetune_ctxfree_%j.out
#SBATCH --error=/cluster/work/smslab/2025-eeg_headband/logs/finetune_ctxfree_%j.err
...
python -u scripts/finetune_contextfree_classifierhead.py